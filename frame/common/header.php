...
<style>
    ...
    header {display: fixed; height: 100px; width: 100%; z-index: 999; position: absolute;}
    ...
    nav > ul > li > ul > li {display: none; margin: 15px 0px;}
    nav > ul > li > ul > li > a {font-size: 19px;}
    .detph2 {margin-top: 30px;}
    .bx-wrapper {padding-top: 100px;}
